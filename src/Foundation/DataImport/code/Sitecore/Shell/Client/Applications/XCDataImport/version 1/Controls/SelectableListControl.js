...
define(["sitecore", "userProfile", "Scrollbar", "EndlessPageScroll", "ResizableColumns"], function (sc, userProfile) {
  ...
  */
  var SelectableListControl = Backbone.LayoutManager.extend({
    template: "selectableListControl",
    initialize: function (options) {
      this.parent = options.parent;
  ...
  */
  var controlView = sc.Definitions.Views.ControlView.extend({
    ...
    initialize: function (options) {
      ...
      this.listControl = new SelectableListControl({ model: this.model, parent: this, collection: this.collection, app: this.app });
  ...
  sc.Factories.createComponent("SelectableListControl", controlModel, controlView, ".sc-selectablelistcontrol", SC_Collection);
});