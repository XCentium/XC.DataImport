...
namespace XC.DataImport.Repositories.Repositories
{
    public interface INonSitecoreDatabaseRepository
    {
        ...
        void ClearMultilistFieldValues(Action<string, string> statusMethod, string statusFilepath, DataSet dataSet, string code = "", Tuple<string, string, string> filter = null);
