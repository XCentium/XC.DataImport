...
define(["sitecore", "baseDataprovider"], function (_sc) {
  _sc.Factories.createBaseComponent({
      name: "AsyncServiceDatasource",
    base: "BaseDataProvider",
    selector: "script[type='text/x-sitecore-asyncservicedatasource']",
    ...
    startImport: function (taskId, frameControl) {
        ...
        frameControl.SourceUrl = serverRequestUrl + "?" + "mapping=" + qs["mapping"] + "&taskId=" + taskId;
        frameControl.viewModel.$el[0].contentWindow.location.href = frameControl.SourceUrl;
        //this.performRequest(serverRequestUrl, providerItemProperties, serverRequestParameters, serverRequestOnSuccess);
    },
