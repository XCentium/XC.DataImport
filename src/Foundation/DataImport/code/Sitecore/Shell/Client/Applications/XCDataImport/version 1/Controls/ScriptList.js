...
define(["sitecore", "userProfile", "/-/speak/v1/business/combobox.js", "Scrollbar", "EndlessPageScroll", "ResizableColumns"], function (sc, userProfile, combobox) {
    ...
    */
    var ScriptListControl = Backbone.LayoutManager.extend({
        template: "scriptListControl",
        initialize: function (options) {
            this.parent = options.parent;
            ...
            this.model.on("add:script", this.addScript, this);
            this.setViewModel();
        },
        addScript: function(){
            alert("add script");
    ...
    */
    var controlView = sc.Definitions.Views.ControlView.extend({
        listen: _.extend({}, sc.Definitions.Views.ControlView.prototype.listen, {
            ...
            "detailList:$this:add:script": "addScript",
        }),
        initialize: function (options) {
            this._super();
            ...
            this.listControl = new ScriptListControl({ model: this.model, parent: this, collection: this.collection, app: this.app });
    ...
    sc.Factories.createComponent("ScriptListControl", controlModel, controlView, ".sc-scriptlistcontrol", SC_Collection);
});