...
{
    public class ScriptListControl : ListControl
    {
        public ScriptListControl(RenderingParametersResolver parametersResolver) : base(parametersResolver)
        {
        }
        public override string RenderMainLayout()
        {
            ...
            htmlTextWriter.RenderEndTag();
            htmlTextWriter.AddAttribute(HtmlTextWriterAttribute.Class, "sc-scriptlistcontrol-body");
