...
define(["sitecore", "userProfile", "Scrollbar", "EndlessPageScroll", "ResizableColumns"], function (sc, userProfile) {
    ...
    */
    var FieldListControl = Backbone.LayoutManager.extend({
        template: "fieldListControl",
        initialize: function (options) {
            this.parent = options.parent;
    ...
    */
    ...
    sc.Factories.createComponent("FieldListControl", controlModel, controlView, ".sc-fieldlistcontrol", SC_Collection);
});